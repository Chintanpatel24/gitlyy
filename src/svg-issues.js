...
function generateIssuesSVG(options) {
  ...
  <g transform="translate(${P}, 52)"><rect width="${sw}" height="78" rx="8" fill="#${issueColor}" opacity=".04"/><text x="${sw / 2}" y="40" text-anchor="middle" class="n" fill="#${issueColor}">${openIssues}</text><text x="${sw / 2}" y="58" text-anchor="middle" class="l" fill="#8b949e">Open</text></g>
  <g transform="translate(${P + sw + 12}, 52)"><rect width="${sw}" height="78" rx="8" fill="#${issueColor}" opacity=".06"/><text x="${sw / 2}" y="40" text-anchor="middle" class="n" fill="#${issueColor}">${totalIssues}</text><text x="${sw / 2}" y="58" text-anchor="middle" class="l" fill="#8b949e">Total Issues</text></g>
