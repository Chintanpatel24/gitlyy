...
function generatePRSummarySVG(options) {
  ...
  <rect width="${cardWidth}" height="${cardHeight}" fill="#0d1117" ${hba}/>
  <rect width="${cardWidth}" height="3" fill="#${accentColor}" rx="8"/>
  <circle cx="${P + 8}" cy="22" r="5" fill="#${accentColor}" opacity=".2"/><circle cx="${P + 8}" cy="22" r="2.5" fill="#${accentColor}"/>
  <text x="${P + 18}" y="26" class="t" fill="#${titleColor}">Pull Requests</text>
