...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const svg = generateContribCard({ username, contributions: data });
    res.end(svg);
  } catch (err) {
    res.end(errorSVG("Could not load contribution data."));
  }
};

function errorSVG(msg) {
  return `<svg width="800" height="80" xmlns="http://www.w3.org/2000/svg">
    <rect width="800" height="80" rx="8" fill="#0d1117" stroke="#f85149" stroke-width="1"/>
